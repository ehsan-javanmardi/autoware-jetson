...
└── components/tier4_sensing_component.launch.xml       autoware_launch
    └── sensing.launch.xml                              tier4_sensing_launch
        ...
        │
        └── sensing.launch.xml                          segway_sensor_kit_launch
...
`sensor_model:=segway_sensor_kit` resolves to the package
`segway_sensor_kit_launch`, and Autoware then includes **that package's**
...
ros2 pkg prefix segway_sensor_kit_launch
